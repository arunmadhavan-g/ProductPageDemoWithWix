...
const productDetails = {
    ...
    offers: ["Bank Offer10% Instant Discount with HDFC Bank Credit Cards and Credit/Debit EMI Transactions",
    ...
    specs: [
        {
            type: 'In The Box',
            value: 'Handset, Earphone, USB Type-C cable, USB Power Adapter, SIM Ejector, Protective Case, Protective Film (applied), Documentation'
        },
